...
## Human notes
Capture here only what discovery cannot infer:

- Bounded contexts / core domains:
- Key external integrations:
- Critical paths (must never break):
- Known constraints / tech debt:

## Existing docs (link, don't copy)
- [ ] Link to the canonical architecture doc, if one exists.
