# AI / LLM Integration — Engineering Pack
...
Install into a project with `nxai pack add ai`; the Pack Provider then feeds its policies/checklists/context to the agents working in this domain. This pack contains **no code and no AI** — it organizes knowledge so the model applies it correctly.
